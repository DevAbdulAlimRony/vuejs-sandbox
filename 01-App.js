...
const app = Vue.createApp({
    ...
    */
    ...
    // Exmp: App.vue can be our root componet. const app = createApp(App)
    // An application instance won't render anything until its .mount() method is called.
    // app.mount('#app'), <div id="app"></div>
    // Defining an app-level error handler that captures errors from all descendant components: app.config.errorHandler = (err) => {}
    // The createApp API allows multiple Vue applications to co-exist on the same page, each with its own scope for configuration and global assets like User and Admin.
